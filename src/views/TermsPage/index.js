  ...
  return (
    <>
      ...
      <p>
        ...
        of iDev's Website, located at iDev.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use iDev if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing iDev, you agreed to use
        cookies in agreement with the iDev's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, iDev and/or its licensors own the intellectual
        property rights for all material on iDev. All intellectual property
        rights are reserved. You may access this from iDev for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from iDev</li>
        <li>Sell, rent or sub-license material from iDev</li>
        <li>Reproduce, duplicate or copy material from iDev</li>
        <li>Redistribute content from iDev</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. iDev
        ...
        of iDev,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, iDev shall not be liable for the Comments
      ...
      <p>
        iDev reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant iDev a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of iDev; and (d) the link is in
      ...
      <p>
        ...
        e-mail to iDev. Please include your name, your organization name,
      ...
      <p>
        No use of iDev's logo or other artwork will be allowed for linking
